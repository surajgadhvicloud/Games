...
public class MemberService(BoardGamesDbContext dbContext, ICurrentUserService currentUserService) : IMemberService
{
    ...
    public async Task<PagedResponse<MemberResponse>> ListAsync(int page, int pageSize, CancellationToken cancellationToken)
    {
        ...
        return new PagedResponse<MemberResponse>(items, totalCount, page, pageSize);
    }
